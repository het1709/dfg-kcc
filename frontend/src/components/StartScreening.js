    ...
    return (
        <div className="start-screening">
            ...
            <div className="row">
                ...
                <div className="form-group col-md-12">
                    <label htmlFor="createPassword">Create a Password (min. 8 characters)</label>
                    <input type="password" className="form-control" type="password" name="createPassword" id="createPassword" aria-describedby="createPasswordInput" placeholder=" " />
                </div>
            </div>
            <div className="row">
